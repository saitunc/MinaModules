...
function main() {
    let s = Provable.witness(ForeignScalar.Canonical.provable, ForeignScalar.random);
    let t = Provable.witness(ForeignScalar.Canonical.provable, ForeignScalar.random);
    s.mul(t);
}
