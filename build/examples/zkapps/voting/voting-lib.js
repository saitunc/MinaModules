import { MyMerkleWitness } from './member.js';
 ...
 */
export function registerMember(i, m, store, Local) {
 ...
 */
export function vote(i, votesStore, candidateStore) {
 ...
 */
export function getResults(voting, votesStore) {
 ...
 */
export async function assertValidTx(expectToBeValid, cb, signers, msg) {
    let failed = false;
    let err;
...
//# sourceMappingURL=voting-lib.js.map