...
let params = {
    candidatePreconditions: new ParticipantPreconditions(UInt64.from(0), UInt64.from(100000000000)),
    voterPreconditions: new ParticipantPreconditions(UInt64.from(0), UInt64.from(100000000000)),
...
tx = await Mina.transaction({ sender: feePayerAddress, fee: 10000000, memo: 'Casting vote' }, async () => {
...
tx = await Mina.transaction({ sender: feePayerAddress, fee: 10000000, memo: 'Counting votes' }, async () => {
