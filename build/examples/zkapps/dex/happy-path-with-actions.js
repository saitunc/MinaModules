...
import { Dex, DexTokenHolder, addresses, getTokenBalances, keys, tokenIds, } from './dex-with-actions.js';
...
tx = await Mina.transaction(feePayer, async () => {
    ...
    AccountUpdate.createSigned(feePayer).balance.subInPlace(Mina.getNetworkConstants().accountCreationFee.mul(3));
    await dex.deploy();
...
//# sourceMappingURL=happy-path-with-actions.js.map