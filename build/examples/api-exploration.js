import { Field, Bool, Group, Scalar, PrivateKey, PublicKey, Signature, Int64, Provable, Struct, } from 'o1js';
...
const c = Provable.if(b1, CompoundType, { foo: [x0, z], bar: { x: x1, b: b1 } }, { foo: [z, x0], bar: { x: z, b: b0 } });
...
let g4 = g3.scale(s0);
//# sourceMappingURL=api-exploration.js.map