import { DynamicProof, Field, MerkleTree, MerkleWitness, SelfProof, Struct, VerificationKey, ZkProgram, verify, } from 'o1js';
/**
...
const proof1 = await mainProgram.addSideloadedProgram(new MainProgramState({
    treeRoot: rootBefore,
    state: Field(0),
}), programVk, witness);
...
const proof2 = await mainProgram.validateUsingTree(proof1.publicOutput, proof1, programVk, witness, SideloadedProgramProof.fromProof(childProof));
