...
if (!fieldsEqual)
    throw Error('roundtrip fields -> bytes -> fields failed');
else
    console.log('fields -> bytes -> fields: ok');
// random bytes
...
if (!bytesEqual)
    throw Error('roundtrip bytes -> fields -> bytes failed');
else
    console.log('bytes -> fields -> bytes: ok');
function arrayEqual(a, b, isEqual) {
...
//# sourceMappingURL=encoding-bijective.js.map