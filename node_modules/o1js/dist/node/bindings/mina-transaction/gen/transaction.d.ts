...
declare let provableFromLayout: <T, TValue, TJson>(typeData: GenericLayout<TypeMap>) => GenericProvableExtended<T, TValue, TJson, import("../../../lib/provable/field.js").Field>, toJSONEssential: (typeData: GenericLayout<TypeMap>, value: any) => any, empty: (typeData: GenericLayout<TypeMap>) => any;
type ZkappCommand = {
    feePayer: {
        body: {
            publicKey: PublicKey;
...
declare let ZkappCommand: GenericProvableExtended<ZkappCommand, Value.ZkappCommand, Json.ZkappCommand, import("../../../lib/provable/field.js").Field>;
type AccountUpdate = {
    body: {
        publicKey: PublicKey;
        tokenId: TokenId;
...
declare let AccountUpdate: GenericProvableExtended<AccountUpdate, Value.AccountUpdate, Json.AccountUpdate, import("../../../lib/provable/field.js").Field>;
type Account = {
    publicKey: PublicKey;
    tokenId: TokenId;
    tokenSymbol: string;
...
declare let Account: GenericProvableExtended<Account, Value.Account, Json.Account, import("../../../lib/provable/field.js").Field>;
